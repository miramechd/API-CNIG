...
function fun(M_) {
   ...
   * @api stable
   */
  M_.config('MAPEA_URL', 'https://ignogcapiguadaltel.desarrollo.guadaltel.es/api-core/');
   ...
   * @api stable
   */
  M_.config('PROXY_URL', location.protocol + '//ignogcapiguadaltel.desarrollo.guadaltel.es/api-core/api/proxy');
   ...
   * @api stable
   */
  M_.config('PROXY_POST_URL', location.protocol + '//ignogcapiguadaltel.desarrollo.guadaltel.es/api-core/proxyPost');
   ...
   * @api stable
   */
  M_.config('THEME_URL', location.protocol + '//ignogcapiguadaltel.desarrollo.guadaltel.es/api-core/assets/');
