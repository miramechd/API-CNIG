   ...
   %>
    <script type="text/javascript">
        ...
        buttonApi.addEventListener('click', function() {
            ...
            window.location.href = 'https://ignogcapiguadaltel.desarrollo.guadaltel.es/api-core//api-core/?contactlink=' + posicion + '*' + descargascnig + '*' + pnoa + '*' + visualizador3d + '*' + fototeca +
